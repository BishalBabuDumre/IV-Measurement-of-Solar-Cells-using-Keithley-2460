...
commands1 = [
    ...
    'SOUR:VOLT:RANG 2', #This means that the max volt we will be using is 2V.
    ...
    'SOUR:SWE:VOLT:LIN 2, 0, 101, 0.01, 1, BEST, ON, OFF, "defbuffer2"', #This will be explained in detail in README.
    ':INIT' #Initialize.
]
